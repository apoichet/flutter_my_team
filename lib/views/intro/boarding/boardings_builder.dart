...
List<Boarding> buildBoardings() {
  return <Boarding> [
    ...
    Boarding(
        ...
        description: 'Tu pourras également comparer tes statistiques personnelles avec les autres joueurs du club, ou tout simplement consulter les différents classements. '),
    Boarding(
        imagePath: 'boarding_3',
        backgroundPath: 'background_4',
        title: 'Compositions d’équipe',
        description: 'Chaque semaine découvre en avant première la composition du soir !  Tu pourras également consulter les compositions des semaines passées.'),
    Boarding(
        imagePath: 'boarding_4',
        backgroundPath: 'background_5',
        title: 'Calendrier / Résultats',
        description: 'Tu pourras bien sûr consulter l’ensemble de nos résultats, notre classement et les matchs à venir sur le site de la FFF !'),
  ];
}
